...
@/Users/sameer/Documents/hiring.ai/.gemini/get-shit-done/references/questioning.md
...
```bash
node "/Users/sameer/Documents/hiring.ai/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
