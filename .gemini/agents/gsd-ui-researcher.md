...
Use template from `/Users/sameer/Documents/hiring.ai/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/sameer/Documents/hiring.ai/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/sameer/Documents/hiring.ai/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
