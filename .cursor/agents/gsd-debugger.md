...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/sameer/Documents/hiring.ai/.cursor
                  → checks /Users/sameer/Documents/hiring.ai/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/sameer/Documents/hiring.ai/.cursor/get-shit-done
                  → writes to /Users/sameer/Documents/hiring.ai/.cursor/get-shit-done/hooks/
...
@/Users/sameer/Documents/hiring.ai/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/sameer/Documents/hiring.ai/.cursor/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/sameer/Documents/hiring.ai/.cursor/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/sameer/Documents/hiring.ai/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/sameer/Documents/hiring.ai/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
