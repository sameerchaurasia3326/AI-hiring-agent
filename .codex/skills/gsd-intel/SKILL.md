...
Intel system is disabled. To activate:
  ...
  node /Users/sameer/Documents/hiring.ai/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/sameer/Documents/hiring.ai/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/sameer/Documents/hiring.ai/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/sameer/Documents/hiring.ai/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/sameer/Documents/hiring.ai/.codex/get-shit-done/bin/gsd-tools.cjs
