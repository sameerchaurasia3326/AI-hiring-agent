...
- **Global scope**: `/Users/sameer/Documents/hiring.ai/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sameer/Documents/hiring.ai/.codex/notes/`)
...
2. Glob `/Users/sameer/Documents/hiring.ai/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sameer/Documents/hiring.ai/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sameer/Documents/hiring.ai/.codex/notes/` — works in any directory
